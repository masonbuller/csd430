...
<%@page import="csd430.eshop.beans.CartItem"%>
...
<head>
  ...
  <title>Order</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/eshop.css" type="text/css"/>
  </head>
<body>
...
<div class="content">
  <h2>Order</h2>
  <jsp:useBean id="customer" class="csd430.eshop.beans.Customer"/>
